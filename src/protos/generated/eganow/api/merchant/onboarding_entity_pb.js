 ...
 * @constructor
 */
proto.eganow.api.merchant.BusinessContactPerson = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.eganow.api.merchant.BusinessContactPerson, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.eganow.api.merchant.BusinessContactPerson.displayName = 'proto.eganow.api.merchant.BusinessContactPerson';
}
 ...
 * @return {!Object}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.toObject = function(opt_includeInstance) {
  return proto.eganow.api.merchant.BusinessContactPerson.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.eganow.api.merchant.BusinessContactPerson} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.eganow.api.merchant.BusinessContactPerson.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    makerid: jspb.Message.getFieldWithDefault(msg, 8, ""),
    makedate: jspb.Message.getFieldWithDefault(msg, 9, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.eganow.api.merchant.BusinessContactPerson}
 */
proto.eganow.api.merchant.BusinessContactPerson.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.eganow.api.merchant.BusinessContactPerson;
  return proto.eganow.api.merchant.BusinessContactPerson.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.eganow.api.merchant.BusinessContactPerson} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.eganow.api.merchant.BusinessContactPerson}
 */
proto.eganow.api.merchant.BusinessContactPerson.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setCustomerguidprospective(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
      msg.setFirstname(value);
 ...
 * @return {!Uint8Array}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.eganow.api.merchant.BusinessContactPerson.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.eganow.api.merchant.BusinessContactPerson} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.eganow.api.merchant.BusinessContactPerson.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getCustomerguidprospective();
  if (f.length > 0) {
    writer.writeString(
      2,
      f
...
/**
 * optional string CustomerGuidProspective = 2;
 * @return {string}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.getCustomerguidprospective = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.eganow.api.merchant.BusinessContactPerson} returns this
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.setCustomerguidprospective = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.getFirstname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.eganow.api.merchant.BusinessContactPerson} returns this
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.setFirstname = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.getLastname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.eganow.api.merchant.BusinessContactPerson} returns this
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.setLastname = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.getPosition = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.eganow.api.merchant.BusinessContactPerson} returns this
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.setPosition = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @return {string}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.getMobilenumber = function() {
 ...
 * @return {!proto.eganow.api.merchant.BusinessContactPerson} returns this
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.setMobilenumber = function(value) {
 ...
 * @return {string}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.getEmailaddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 7, ""));
};
 ...
 * @return {!proto.eganow.api.merchant.BusinessContactPerson} returns this
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.setEmailaddress = function(value) {
  return jspb.Message.setProto3StringField(this, 7, value);
};


/**
 * optional string MakerId = 8;
 * @return {string}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.getMakerid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};
 ...
 * @return {!proto.eganow.api.merchant.BusinessContactPerson} returns this
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.setMakerid = function(value) {
  return jspb.Message.setProto3StringField(this, 8, value);
};


/**
 * optional string MakeDate = 9;
 * @return {string}
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.getMakedate = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 9, ""));
};
 ...
 * @return {!proto.eganow.api.merchant.BusinessContactPerson} returns this
 */
proto.eganow.api.merchant.BusinessContactPerson.prototype.setMakedate = function(value) {
  return jspb.Message.setProto3StringField(this, 9, value);
};
 ...
 * @enum {number}
 */
proto.eganow.api.merchant.DirectorPosition = {
 ...
 * @enum {number}
 */
proto.eganow.api.merchant.CustomerIDTypes = {

...
export default function merchantContactPersonAPI() {
  ...
  return {
    listBusinessContactPersons: () =>
      axiosInstance.get('/api/v1/merchants/accounts/contact-persons'),
    addBusinessContactPerson: (param: BusinessContactPersonType) =>
      axiosInstance.post('/api/v1/merchants/accounts/contact-persons', param),
    updateBusinessContactPerson: (param: BusinessContactPersonType) =>
      axiosInstance.put('/api/v1/merchants/accounts/contact-persons', param),
    deleteBusinessContactPerson: (id: string) =>
      axiosInstance.delete(`/api/v1/merchants/accounts/contact-persons/${id}`),
  }
}

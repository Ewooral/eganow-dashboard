...
const InternalTransfer: NextPageWithLayout = (props) => {
  ...
  function handleModal() {
    ...
    setDynamicComponent(
      <AddEditSettlements modalClose={modalClose} data={userData} callback={callback} />,
    )
  }
      ...
      <div className="d-flex justify-content-between align-items-center flex-wrap rounded pt-2">
        <div className="flex-grow-1">
          <h1 className="fs-3 fw-bold text-danger-emphasis" style={{ color: '#CC0229' }}>
            <FaMoneyCheck className="fs-2 fw-bold me-2" />
            Settlement Request
          </h1>
          <small className="text-secondary">
            Request for settlement of funds and financial transfer processing.
          </small>
        </div>
        ...
        <div className="flex gap-2">
          ...
          >
            <FaMoneyCheck style={{ fontSize: '1.2rem' }} className="me-1" />
            Request settlement
          </CButton>{' '}

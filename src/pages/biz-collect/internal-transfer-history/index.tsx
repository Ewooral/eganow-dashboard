...
import { cilArrowTop, cilChartPie, cilLoopCircular, cilSearch, cilNotes } from '@coreui/icons'
/*FONT AWESOME ICONS */
...
const InternalTransferHistory: NextPageWithLayout = (props) => {
  // Dynamic Components
  ...
  function handleModal() {
    ...
    setDynamicComponent(
      <AddEditInternalTransfer modalClose={modalClose} data={userData} callback={callback} />,
    )
  }
      ...
      <div className="d-flex justify-content-between align-items-center flex-wrap rounded pt-2">
        <div className="flex-grow-1">
          <h1 className="fs-3 fw-bold text-danger-emphasis" style={{ color: '#CC0229' }}>
            <FaHistory className="fs-2 fw-bold me-2" />
            Internal Transfer History
          </h1>
          <small className="text-secondary">
            Internal fund transfer transaction history and records of fund movements.
          </small>
        </div>
              ...
              <CFormSelect
                ...
                options={[
                  { label: 'ALL', value: 'ALL' },
                  {
                    ...
                    value: 'TRANSFER_COLLECTION_TO_PAYOUT',
                  },
                  {
        ...
        <CCard className="border-0 shadow-none p-1">
          <CSmartTable
            ...
            scopedColumns={{
              ...
              transactionstatus: (items) => StatusColumn(items.transactionstatus),
              authorizationstatus: (items) => StatusColumn(items.authorizationstatus),

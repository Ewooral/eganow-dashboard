...
import AddEditInternalTransfer from '@/components/collection/AddEditCollection'
/* 
...
const columns = [
  ...
  },
  {
    label: 'Narration',
    key: 'narration',
    _style: { minWidth: '200px', width: '30%' },
  },
  {
    label: 'Status',
    key: 'status',
...
const Collection: NextPageWithLayout = (props) => {
  // Dynamic Components
      ...
      <div className="d-flex justify-content-between align-items-center flex-wrap rounded pt-2">
        <div className="flex-grow-1">
          <h1 className="fs-3 fw-bold text-danger-emphasis" style={{ color: '#CC0229' }}>
            <BsCollectionFill className="fs-1 fw-bold me-2" />
            Collection
          </h1>
          <small className="text-secondary">Manual initiation of a collection transaction.</small>
        </div>
        ...
        <div className="flex gap-2">
          ...
          >
            <BsCollectionFill style={{ fontSize: '1.2rem' }} className="me-1" />
            Initiate collection
          </CButton>{' '}
                ...
                return (
                  <td className="py-2">
                    <CButton
                      ...
                      className="text-white"
                    >
                      <CIcon icon={cilChartPie} data-type="resetPassword" />
                    </CButton>
                  </td>
                )
              },

      ...
      <CRow>
                    ...
                    datasets: [
                      {
                        ...
                        data: [65, 59, 84, 84, 51, 55, 40], // analytics?.monthlyBalance.collection.monthlyValues.slice(0, 8), // [65, 59, 84, 84, 51, 55, 40],
                      },
                    ],
                  }}
                  options={{
        ...
        <CCol sm={6} md={3}>
            ...
            <CWidgetStatsA
              ...
              value={
                <div className="text-black dark:text-white">
                  {/* GHS {analytics?.monthlyBalance.payout.availableBalance || 0}{' '} */} GHS 700
                  <span className="fs-6 fw-normal text-black dark:text-white">
                    (29%)
                    {/* (
                    ...
                    datasets: [
                      {
                        ...
                        borderColor: '#304767',
                        pointBackgroundColor: '#304767',
                        data: [78, 81, 80, 45, 34, 12, 40], //analytics?.monthlyBalance.payout.monthlyValues.slice(0, 8), // [78, 81, 80, 45, 34, 12, 40],
                        fill: true,
                      },
                    ],
                  }}
                    ...
                    datasets: [
                      {
                        ...
                        borderColor: '#304767',
                        data: [78, 81, 80, 45, 34, 12, 40], // analytics?.monthlyBalance.commission.monthlyValues, // [78, 81, 80, 45, 34, 12, 40, 85, 65, 23, 12, 98, 34, 84, 67, 82],
                        barPercentage: 0.6,
                      },
                    ],
                  }}
                    ...
                    datasets: [
                      {
                        ...
                        backgroundColor: '#304767',
                        borderColor: '#304767',
                        data: [78, 81, 80, 45, 34, 12, 40, 85], //analytics?.monthlyBalance.totalSettlements.monthlyValues, // [78, 81, 80, 45, 34, 12, 40, 85, 65, 23, 12, 98, 34, 84, 67, 82],
                        barPercentage: 0.6,
                      },
                    ],
                  }}
                ...
                <CCardBody className="row pt-1 ">
                  <div className="h-50  p-1 col-md-6">
                    <CChart
                      ...
                      type="pie"
                      data={{
                        labels: [{name:"Momo",value:400},{name:"Card",value:400},{name:"POS",value:400}].map((method) => method.name),
                        datasets: [
                          {
                  ...
                  <div className="col-md-6 p-1">
                    <CTable className="w-100  h-100">
                      ...
                      <CTableBody>
                        {[{name:"Momo",value:400},{name:"Card",value:400},{name:"POS",value:400}]?.map((method, index) => (
                          <CTableRow key={index}>
                            <CTableDataCell className="text-start align-middle">
                              <CBadge
                                shape="rounded-pill"
                            ...
                            <CTableDataCell className="text-end align-middle">
                              ...
                              {/* {isPending ? (
                                <Loader2
                                  size={14}
                                  className="h-2 w-2 animate-spin loader text-muted-foreground"
                                />
                              ) : (

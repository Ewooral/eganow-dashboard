...
const InternalTransfer: NextPageWithLayout = (props) => {
  ...
  function handleModal() {
    ...
    setDynamicComponent(
      <AddEditPayments modalClose={modalClose} data={userData} callback={callback} />,
    )
  }
      ...
      <div className="d-flex justify-content-between align-items-center flex-wrap rounded pt-2">
        <div className="flex-grow-1">
          <h1 className="fs-3 fw-bold text-danger-emphasis" style={{ color: '#CC0229' }}>
            <MdPayment className="fs-2 fw-bold me-2" />
            Payments
          </h1>
          <small className="text-secondary">View/ edit payments/ disbursements to customers</small>
        </div>
        ...
        <div className="flex gap-2">
          ...
          >
            <FaMoneyBillAlt style={{ fontSize: '1.2rem' }} className="me-1" />

      ...
      {props?.contactInfo?.isLoading ? (
        ...
        <CForm onSubmit={handleSubmit(onSubmit)}>
          <CRow className="mb-4 px-4">
            <CCol sm={6}>
              <CCard className="p-3 border shadow-none">
                ...
                <CCol>
                  ...
                  >
                    <strong className="text-secondary">Business Address</strong>
                  </CFormLabel>
                  {!props.type ? (
                    <p className="m-0 fw-bold">{props?.contactInfo?.data?.streetAddress}</p>
                  ) : (
                    <div>
                      <CFormTextarea
                        id="streetAddress"
                        ...
                        rows={'auto'}
                        valid={
                          formState.dirtyFields?.streetAddress && !!!formState.errors?.streetAddress
                            ? true
                            : false
                        }
                ...
                <CCol>
                  <CFormLabel htmlFor="companyName" className="form-label mt-3">
                    <strong className="text-secondary">City/ Town</strong>
                  </CFormLabel>
                  {!props.type ? (
                    <p className="m-0 fw-bold">{props?.contactInfo?.data?.city}</p>
                  ) : (
                    <div>
                      <CFormInput
                        type="text"
                        ...
                        valid={
                          formState.dirtyFields?.city && !!!formState.errors?.city ? true : false
                        }
                ...
                <CCol>
                  <CFormLabel htmlFor="state" className="form-label mt-3">
                    <strong className="text-secondary">State/ Province/ Region</strong>
                  </CFormLabel>
                  {!props.type ? (
                    <p className="m-0 fw-bold">{props?.contactInfo?.data?.provinceState}</p>
                  ) : (
                    <div>
                      <CFormInput
                        type="text"
                        ...
                        valid={
                          formState.dirtyFields?.state && !!!formState.errors?.state ? true : false
                        }
                ...
                <CCol>
                  <CFormLabel htmlFor="postalCode" className="form-label mt-3">
                    <strong className="text-secondary">Postal/ Zip Code</strong>
                  </CFormLabel>
                  {!props.type ? (
                    <p className="m-0 fw-bold">{props?.contactInfo?.data?.postalZipCode}</p>
                  ) : (
                    <div>
                      <CFormInput
                        type="text"
                        ...
                        valid={
                          formState.dirtyFields?.postalCode && !!!formState.errors?.postalCode
                            ? true
                            : false
                        }
                ...
                <CCol>
                  <CFormLabel htmlFor="companyRegistrationNumber" className="form-label mt-3">
                    <strong className="text-secondary">Digital Address</strong>
                  </CFormLabel>
                  {!props.type ? (
                    <p className="m-0 fw-bold">{props?.contactInfo?.data?.digitalAddress}</p>
                  ) : (
                    <div>
                      <CFormInput
                        type="text"
                ...
                <CCol>
                  <CFormLabel htmlFor="postalAddress" className="form-label mt-3">
                    <strong className="text-secondary">Postal Address</strong>
                  </CFormLabel>
                  {!props.type ? (
                    <p className="m-0 fw-bold">{props?.contactInfo?.data?.postalAddress}</p>
                  ) : (
                    <div>
                      <CFormTextarea
                        id="postalAddress"
                        ...
                        valid={
                          formState.dirtyFields?.postalAddress && !!!formState.errors?.postalAddress
                            ? true
                            : false
                        }
            ...
            <CCol sm={6}>
              <CCard className="p-3 border shadow-none">
                <strong className="">Contact Info</strong>
                ...
                <CCol>
                  <CFormLabel htmlFor="officeOwnership" className="form-label">
                    <strong className="text-secondary">Office Ownership</strong>
                  </CFormLabel>
                  {!props.type ? (
                    <p className="m-0 fw-bold">
                      {getOfficeOwner(props?.contactInfo?.data?.officeOwnership)}
                    </p>
                  ) : (
                    <div>
                      <CFormSelect
                ...
                <CCol>
                  <CFormLabel htmlFor="licenseIssuedDate" className="form-label mt-3">
                    <strong className="text-secondary">First Occupancy Date</strong>
                  </CFormLabel>
                  {!props.type ? (
                    <p className="m-0 fw-bold">
                      {formatDate_util(
                        props?.contactInfo?.data?.firstOccupancyDate,
                        'MMMM dd, yyyy',
                      )}
                    </p>
                  ) : (
                    <div>
                      <CDatePicker
                        ...
                        locale="en-US"
                        valid={
                          formState.dirtyFields?.firstOccupancyDate &&
                          !formState.errors?.firstOccupancyDate
                        }
                ...
                <CCol>
                  <CFormLabel htmlFor="mobileNumber" className="form-label mt-3">
                    <strong className="text-secondary">Office Telephone/ Mobile Number</strong>
                  </CFormLabel>
                  {!props.type ? (
                    <p className="m-0 fw-bold">{props?.contactInfo?.data?.mobileNumber}</p>
                  ) : (
                    <div>
                      <CFormInput
                        type="text"

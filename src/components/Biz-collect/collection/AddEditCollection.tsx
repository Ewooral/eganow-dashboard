 ...
 *
 */
const AddEditCollection = (props: AgentModalProps) => {
    ...
    >
      <CModalHeader>
        <CModalTitle id="VerticallyCenteredExample" style={{ color: '#CC0229' }}>
          <BsCollectionFill className="fs-2 mr-2" />{' '}
          <strong> {props.data?.type === 'new' ? 'Collection' : 'Update Collection'}</strong>
        </CModalTitle>
      </CModalHeader>
      <CModalBody>
        <CForm noValidate>
      ...
      <CModalFooter>
        <CButton color="danger" className='text-white' onMouseUp={handleSubmit(onSubmit)} disabled={formState.isSubmitting}>

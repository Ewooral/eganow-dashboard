 ...
 *
 */
const AddEditPaymentLinks = (props: AgentModalProps) => {
    ...
    >
      <CModalHeader>
        <CModalTitle id="VerticallyCenteredExample" style={{ color: '#CC0229' }}>
          <MdOutlinePayment className="fs-2 mr-2" />{' '}
          <strong>
            {' '}
            {props.data?.type === 'new'
              ? 'Generate Payment Links'
              : 'Update Generate Payment Links'}
          </strong>
        </CModalTitle>
      </CModalHeader>
      <CModalBody>
        <CForm noValidate>
          ...
          <div className="row">
            <div className="col mb-4">
              ...
              >
                <strong>Can user change transaction amount? </strong>
              </CFormLabel>
              <CFormSelect
                id="status"
                name="status"
            ...
            <div className="col mb-4">
              ...
              >
                <strong>Type of payment link</strong>
              </CFormLabel>
              <CFormSelect
                id="status"
                name="status"
          ...
          <div className="mb-4">
            ...
            >
              <strong>Number of days link expires</strong>
            </CFormLabel>
            <CFormInput
              type="number"
              id="mobilenumber"
              max={10}
              placeholder="Enter days link expires here."
              {...register('mobilenumber')}
              valid={
                formState.dirtyFields?.mobilenumber && !!!formState.errors?.mobilenumber
                  ? true
      ...
      <CModalFooter>
        ...
        >
          {props.data?.type === 'new' ? 'Generate' : 'Save Changes'}
...
export default AddEditPaymentLinks
